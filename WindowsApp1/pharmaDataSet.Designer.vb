...
Namespace pharmaDataSetTableAdapters
    ...
    Partial Public Class meds_inventoryTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT DISTINCT Med_ID, Medicine, category, expiration_date, Price, Qty FROM phar"& _ 
                "ma.meds_inventory"
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As pharmaDataSet.meds_inventoryDataTable) As Integer
